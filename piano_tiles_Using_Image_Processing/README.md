This Code is developed to Automate the Piano Tiles game using Image Processing,Before you run the code please install Image Processing tool box in Matlab and ADB tool .
